        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Flavour</label>
                        <p class="form-control-static"><?php echo $row["flavour"]; ?></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Add On</label>
                        <p class="form-control-static"><?php echo $row["addon"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Order Notes</label>
                        <p class="form-control-static"><?php echo $row["ordernotes"]; ?></p>
                    </div>
                    ...
                    <p><a href="orderList.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
