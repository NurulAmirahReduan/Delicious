...
label{
  ...
  font-size:200%;
  text-align: center;
  font-family:'Apple Chancery','ITC Zapf Chancery','URW Chancery L',cursive;
  color: #000000;
...
<div class="form-group">
  <img src="img/fruitCake.jpg" alt="fruitCake"  width="460" height="345"></a>
  <div>
    <div><br>
      <center><label for="nTitle">FRUIT CAKE</label></center>
...
<form action="/.php">
            ...
            <div class="form-group">
                 <div class="column">
                    ...
                    <select id="oWeight" name="oWeight" >
