      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="heading-title text-center">
            <h1 class="header-h">Your Order's Reservation</h1>
            <p>Describe about order</p>
          </div>
        </div>
      </div>
                    <div class="form-group">
                        <label>Product Title</label>
                        <p class="form-control"><?php echo $row["product"]; ?></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Flavour</label>
                        <p class="form-control"><?php echo $row["flavour"]; ?></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Add On</label>
                        <p class="form-control"><?php echo $row["addon"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Order Notes</label>
                        <p class="form-control"><?php echo $row["ordernotes"]; ?></p>
                    </div>

                    <div class="form-group">
                        <label>Order Status</label>
                        <p class="form-control"><?php echo $row["status"]; ?></p>
                    </div>

                    <p><center><div class="col-sm-5 form-group"><a href="orderList.php" class="btn btn-lg btn-warning btn-block">Back</a></div>

                      <p><center><div class="col-sm-5 form-group"><a href="pay.php" class="btn btn-lg btn-warning btn-block">Proceed to Pay</a></div>
