      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="heading-title text-center">
            <h1 class="header-h">Our's Product</h1>
            <p>Describe about product</p>
          </div>
        </div>
      </div>
                    ...
                    <p><center><div class="col-sm-5 form-group"><a href="product.php" class="btn btn-lg btn-warning btn-block">Back</a></div>
</div>
</div>
