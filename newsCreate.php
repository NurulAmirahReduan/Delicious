...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($title_err) && empty($detail_err) && empty($description_err)){
        // Prepare an insert statement
        $sql = "INSERT INTO news (title, detail, description) VALUES (?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sss", $param_title, $param_detail, $param_description);
