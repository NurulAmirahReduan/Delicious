...
$link = mysqli_connect("localhost", "root", "", "whbms");
...
$uPwd = mysqli_real_escape_string($link, $_REQUEST['uPwd']);
$uFname = mysqli_real_escape_string($link, $_REQUEST['uFname']);
$uPnum = mysqli_real_escape_string($link, $_REQUEST['uPnum']);
$uAddress = mysqli_real_escape_string($link, $_REQUEST['uAddress']);
$uEmail = mysqli_real_escape_string($link, $_REQUEST['uEmail']);
 
// Attempt insert query execution
$sql = "INSERT INTO user_detail (uName,uPwd,uFname,uPnum,uAddress,uEmail) VALUES ('$uName','$uPwd','$uFname','$uPnum','$uAddress','$uEmail')";
...
<input class="form-control"  id="uName" name="username"></input>
</div>

<div class="form-group">
<label for="password">Password</label>
<input class="form-control"  id="uPwd" name="password"></input>
</div>

<div class="form-group">
<label for="fullName">Full Name</label>
<input class="form-control"  id="uFname" name="fullname"></input>
</div>

<div class="form-group">
<label for="phone">Phone Number</label>
<input class="form-control"  id="uPnum" name="phone"></input>
</div>

<div class="form-group">
<label for="address">Address</label>
<input class="form-control"  id="uAddress" name="address"></input>
</div>

<div class="form-group">
<label for="email">Email</label>
<input class="form-control"  id="uEmail" name="email"></input>
</div>
