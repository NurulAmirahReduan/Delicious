...
$sql = "INSERT INTO users (username,password,fullname,phone,address,email) VALUES ('$username','$password','$fullname','$phone','$address','$email')";
...
<input class="form-control"  id="fullname" name="fullname"></input>
</div>
...
<input class="form-control"  id="uName" name="email"></input>
</div>
